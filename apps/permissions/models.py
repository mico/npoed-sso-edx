...
class Permission(models.Model):
    ...
    Схема такая, что пользователю назначаются роли, а роли могут содержать разные наборы прав.
    '''
...
class Role(models.Model):
    ...
    Соответствие наборов прав sso конкретным ролям пользователям на Open edX:
